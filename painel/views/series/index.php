<div class="col-md-12" id="vmApp">
    <header class="bloco-conteudo">
        ...
        <div class="flex-space-between">
            <div class="titulo font-bold texto-cor-sucesso">Séries</div>
            <div>
        ...
        <div class="flex-a-direita">
            <div class="width300">
                <form action="<?php echo HOME ?>/painel/series" method="post" name="formPesquisa">
...
<script type="module" src="<?php echo HOME ?>/assets/painel/js/series.js"></script>
