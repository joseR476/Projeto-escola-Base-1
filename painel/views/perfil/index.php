<div class="col-md-12" id="vmApp">
    <header class="bloco-conteudo">
        ...
        <div class="titulo font-bold texto-cor-sucesso">Perfil de: <?php echo \Geral\Sessao::getNomeUsuarioPainel() ?></div>
    ...
    <section class="bloco-conteudo">
        ...
        <form method="post" action="<?php echo HOME.'/painel/salvar-perfil' ?>" name="formDados" id="formDados" enctype="multipart/form-data">
